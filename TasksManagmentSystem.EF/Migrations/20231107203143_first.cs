    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Task_s", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Task_s_Managers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Managers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Task_s_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Task_s_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Task_s_ManagerId",
                table: "Task_s",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_Task_s_MemberId",
                table: "Task_s",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Task_s_ProjectId",
                table: "Task_s",
                column: "ProjectId");
        }
